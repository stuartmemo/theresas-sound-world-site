...
(function (window, undefined) {
    ...
    var SoundWorld = (function () {
        ...
        SoundWorld.isBrowserCompatible = function (callback) {
            return true;
        }
         ...
         */
        SoundWorld.applySettings = function (node, settings) {
         ...
         * @method disconnect
         */
        SoundWorld.disconnect = function (node) {
            node.disconnect();
        };
        ...
        */
         ...
         */
        SoundWorld.createCompressor = function (settings) {
            /*
             *  Compressor 
             *  ==========
             *  +----------+     +----------------------+     +---------------+
         ...
         */
        SoundWorld.createProcessor = function (bs, callback) {
         ...
         */
        SoundWorld.createWaveShaper = function () {
         ...
         */
        SoundWorld.createEnvelope = function (settings) {
            var envelope = {};
         ...
         */
        SoundWorld.createNoise = function (colour) {
         ...
         */
        SoundWorld.createLFO = function (settings) {
